...
namespace VoxCrm.Infrastructure.Migrations
{
    ...
    [Migration("20260801083122_AddPetOwnerNationalIdentity")]
    partial class AddPetOwnerNationalIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VoxCrm.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("GuestPhoneLookupHash")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("ClinicID", "GuestPhoneLookupHash");
            ...
            modelBuilder.Entity("VoxCrm.Domain.Entities.Clinic", b =>
                {
                    ...
                    b.Property<bool>("WhatsAppSendWindowEnabled")
                        .HasColumnType("boolean");

                    b.Property<TimeOnly>("WhatsAppSendWindowEnd")
                        .HasColumnType("time without time zone");

                    b.Property<TimeOnly>("WhatsAppSendWindowStart")
                        .HasColumnType("time without time zone");

                    b.Property<string>("WhatsAppTimeZoneId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("VoxCrm.Domain.Entities.PetOwner", b =>
                {
                    ...
                    b.Property<string>("NationalIdentityLookupHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("ClinicID", "NationalIdentityLookupHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("VoxCrm.Domain.Entities.SystemAuditLog", b =>
                {
                    ...
                    b.HasIndex("Source", "Category", "CreatedAt");
            ...
            modelBuilder.Entity("VoxCrm.Domain.Entities.WhatsAppInboundMessage", b =>
                {
                    ...
                    b.ToTable("WhatsAppInboundMessages");
                });
            ...
            modelBuilder.Entity("VoxCrm.Domain.Entities.WhatsAppNotification", b =>
                {
                    ...
                    b.HasIndex("ClinicID", "NotificationType", "Status", "NextAttemptAt");
